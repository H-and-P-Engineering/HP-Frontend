        ...
        <div className="w-full max-w-[1200px] flex flex-col items-center sm:items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-[#E8E5E533] rounded-[18px] shadow-md hover:shadow-lg overflow-hidden flex flex-col relative transition-shadow duration-200">
              <div className="relative w-full h-[150px] bg-gray-300 overflow-hidden rounded-t-[18px]">
              ...
              <div className="p-4 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <button className="ml-auto bg-[#193a63] hover:bg-[#0f2b4a] text-white text-sm font-semibold rounded-[24px] py-2 px-4 flex items-center gap-1 transition-colors">
                    View Vendor &rarr;
                  </button>
                </div>
              </div>
